...
export default defineEventHandler(async (event) => {
  ...
  if (method === "GET") {
    try {
      ...
      // Use the executeQuery helper for better resilience
      const products = await executeQuery(async (prisma) => {
      ...
      // Set response headers with caching for better performance
